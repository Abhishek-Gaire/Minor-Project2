...
const StudentsPage = () => {
    ...
    return (
        <div className="p-6">
            <Header handleAddStudent={handleAddStudent} originalStudents={originalStudents}/>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
                ...
                {/* Pagination Controls */}
                <PaginatedControls currentPage={currentPage} itemsPerPage={itemsPerPage}
                                   filteredStudents={filteredStudents} setItemsPerPage={setItemsPerPage}
