...
const assignmentsData: Assignment[] = [
  {
    ...
    description:
      "Create a program demonstrating the use of different data types in Python.",
  ...
  },
  {
    ...
    description:
      "Write SQL queries to retrieve and manipulate data from the provided database schema.",
  ...
  },
  {
    ...
    description:
      "Create a responsive webpage using HTML and CSS based on the provided mockup.",
  ...
  },
  {
    ...
    description:
      "Conduct a user research study using at least two different methods and document your findings.",
