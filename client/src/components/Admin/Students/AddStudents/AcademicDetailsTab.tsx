...
const AcademicDetailsTab = forwardRef<HTMLDivElement, AcademicDetailsTabProps>(
  ({ form, moveToNextTab, moveToPreviousTab }, ref) => {
    return (
      <TabsContent ref={ref} value="academic" className="space-y-4">
